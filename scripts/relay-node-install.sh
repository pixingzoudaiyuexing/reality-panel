...
#
# Usage:
#   bash <(curl -fsSL https://github.com/pixingzoudaiyuexing/reality-panel/releases/download/v1.1.0-rc.7/relay-node-install.sh) \
#     -t <NODE_TOKEN> -u <PANEL_URL> --version 1.1.0-rc.7
#
# Options:
