...
#
# Usage:
#   bash <(curl -fsSL https://github.com/pixingzoudaiyuexing/reality-panel/releases/download/v1.0.0/relay-node-install.sh) \
#     -t <NODE_TOKEN> -u <PANEL_URL> --version 1.0.0
#
# Options:
